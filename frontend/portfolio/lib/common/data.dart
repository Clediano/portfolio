...
final List<Article> articles = [
  Article(
    ...
    subTitle: "coldly wonderfully marginally far upon excluding",
  ),
  Article(
    image:
    ...
    description: "Greyhound divisively hello coldly wonderfully marginally far upon excluding.",
    subTitle: "marginally far upon excluding",
  ),
  Article(
    image:
    ...
    description: "Greyhound divisively hello coldly wonderfully marginally far upon excluding.",
    subTitle: "coldly wonderfully marginally",
  ),
  Article(
    image:
    ...
    description: "Greyhound divisively hello coldly wonderfully marginally far upon excluding.",
    subTitle: "divisively hello coldly",
  ),
  Article(
    image:
